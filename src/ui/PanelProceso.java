 ...
 *         panel muestra si un proceso es llegado o activo. Tambien se muestra
...
class PanelProceso extends JPanel {
	...
	/**
	 * La altura a la que desea los medidores dibujados. Hago una proporcion de
	 * 1:1 con mi rafaga maxima.
	 */
