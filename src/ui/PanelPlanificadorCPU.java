 ...
 *         predeterminados, ejecutar simulaciones desde una interfaz grafica de
 *         usuario y ver una animacion del proceso gracias a una señal de tiempo
 *         de respuesta a traves de la interfaz ActionListener.
 */
...
public class PanelPlanificadorCPU extends JFrame implements ActionListener {
	...
	/**
	 * Ajuste de FPS para la animacion. Es limitado por la velocidad del
	 * hardware.
	 */
