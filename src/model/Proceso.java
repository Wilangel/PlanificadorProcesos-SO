...
public class Proceso {
	 ...
	 * todos los valores seran pasados por parametros Este metodo es util para
	 * la construccion de una cola de proceso en el que los datos provienen de
	...
	/**
	 * Ir a traves de los movimientos de la ejecucion de un ciclo de un
	...
	/**
	 * El inverso de ejecutando. Ir a trav�s de los movimientos de la espera
