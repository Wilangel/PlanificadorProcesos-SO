 ...
 *         ejecutarse de forma automatica toda la simulacion de una sola vez o
...
public class PlanificadorCPU {
	...
	/**
	 * Cuenta atras de cuando interrumpir un proceso, porque su quantum
	 * termino
	 */
	long quantumCounter = quantum;

	/**
	 * Solo Round Robin, esta variable mantiene un registro del numero de
	...
	/**
	 * Variables para almacenar las estadisticas recogidas en el tiempo de
	...
	/**
	 * SRT y PSJF: Obtiene el trabajo mas pequeno en la cola
	 */
	...
	/**
	 * FCFS: Obtener el proceso que llego primero
	 */
	...
	/**
	 * Loop a traves de la cola de procesos para agarrar las estadisticas
	 * importantes
	 */
	...
	/**
	 * Obtener el proceso que se esta ejecutando activamente
	 */
	...
	/**
	 * Ejecutar toda la simulacion en un bucle while.
	 */
	public void Simular() {
		while (proximoCiclo())
			;
